<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    @if(!$lines->count())
        <div class="bg-mystic-800/50 border border-gold-500/10 rounded-2xl p-12 text-center">
            <p class="text-gray-600 mb-6">No tienes productos en el carrito.</p>
            ...
            <div class="space-y-8">
                <section class="bg-mystic-800/50 border border-gold-500/10 rounded-2xl p-6">
                    ...
                    <div>
                        ...
                        <input type="email" wire:model="email" required class="w-full bg-mystic-950/60 border border-gold-500/20 rounded-md px-4 py-3 text-gray-900 focus:border-gold-400 focus:outline-none">
                ...
                <section class="bg-mystic-800/50 border border-gold-500/10 rounded-2xl p-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" wire:model="firstName" required class="w-full bg-mystic-950/60 border border-gold-500/20 rounded-md px-4 py-3 text-gray-900 focus:border-gold-400 focus:outline-none">
                            @error('firstName') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label class="block text-xs uppercase tracking-widest text-gray-600 mb-1">Apellidos *</label>
                            <input type="text" wire:model="lastName" required class="w-full bg-mystic-950/60 border border-gold-500/20 rounded-md px-4 py-3 text-gray-900 focus:border-gold-400 focus:outline-none">
                            @error('lastName') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-xs uppercase tracking-widest text-gray-600 mb-1">Telefono</label>
                            <input type="tel" wire:model="phone" class="w-full bg-mystic-950/60 border border-gold-500/20 rounded-md px-4 py-3 text-gray-900 focus:border-gold-400 focus:outline-none">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-xs uppercase tracking-widest text-gray-600 mb-1">Direccion *</label>
                            <input type="text" wire:model="line1" required placeholder="Calle y numero" class="w-full bg-mystic-950/60 border border-gold-500/20 rounded-md px-4 py-3 text-gray-900 focus:border-gold-400 focus:outline-none">
                            @error('line1') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-xs uppercase tracking-widest text-gray-600 mb-1">Piso / puerta</label>
                            <input type="text" wire:model="line2" class="w-full bg-mystic-950/60 border border-gold-500/20 rounded-md px-4 py-3 text-gray-900 focus:border-gold-400 focus:outline-none">
                        </div>
                        <div>
                            <label class="block text-xs uppercase tracking-widest text-gray-600 mb-1">Ciudad *</label>
                            <input type="text" wire:model="city" required class="w-full bg-mystic-950/60 border border-gold-500/20 rounded-md px-4 py-3 text-gray-900 focus:border-gold-400 focus:outline-none">
                            @error('city') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label class="block text-xs uppercase tracking-widest text-gray-600 mb-1">Provincia</label>
                            <input type="text" wire:model="state" class="w-full bg-mystic-950/60 border border-gold-500/20 rounded-md px-4 py-3 text-gray-900 focus:border-gold-400 focus:outline-none">
                        </div>
                        <div>
                            <label class="block text-xs uppercase tracking-widest text-gray-600 mb-1">Codigo postal *</label>
                            <input type="text" wire:model="postcode" required class="w-full bg-mystic-950/60 border border-gold-500/20 rounded-md px-4 py-3 text-gray-900 focus:border-gold-400 focus:outline-none">
                            @error('postcode') <span class="text-red-400 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div>
                            <label class="block text-xs uppercase tracking-widest text-gray-600 mb-1">Pais *</label>
                            <select wire:model="countryId" required class="w-full bg-mystic-950/60 border border-gold-500/20 rounded-md px-4 py-3 text-gray-900 focus:border-gold-400 focus:outline-none">
                    ...
                    <div class="space-y-3">
                        <label class="flex items-center gap-4 p-4 bg-mystic-950/60 border border-gold-500/20 rounded-md cursor-pointer hover:border-gold-400 transition">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600">Procesado seguro via Stripe</div>
                            </div>
                        </label>
                        <label class="flex items-center gap-4 p-4 bg-mystic-950/60 border border-gold-500/20 rounded-md cursor-pointer hover:border-gold-400 transition">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-600">Paga con tu cuenta PayPal</div>
                            </div>
                        </label>
                        <label class="flex items-center gap-4 p-4 bg-mystic-950/60 border border-gold-500/20 rounded-md cursor-pointer hover:border-gold-400 transition">
