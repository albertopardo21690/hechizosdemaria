...
<section class="max-w-2xl mx-auto px-4 py-20">
    <div class="text-center mb-12">
        <p class="text-pink-500 text-xs tracking-[0.4em] uppercase mb-2">Hablemos</p>
        <h1 class="font-heading text-4xl md:text-5xl text-shimmer">Contacto</h1>
    </div>

    <div class="bg-white/80 border border-pink-100 rounded-xl p-8 space-y-6">
        ...
        <a href="mailto:hechizosdemaria@gmail.com" class="block text-center text-pink-500 hover:text-pink-700 text-lg">
