@if($editing)
    <div class="grid md:grid-cols-2 gap-3 text-sm">
        <label class="md:col-span-2"><span class="block text-xs uppercase tracking-widest text-gray-600 mb-1">URL de imagen *</span><input type="text" wire:model.lazy="{{ $path }}.props.src" placeholder="/images/branding/..." class="w-full border border-gray-300 rounded-md px-3 py-2 font-mono text-xs"></label>
